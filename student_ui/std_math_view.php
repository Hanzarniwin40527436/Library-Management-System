...
if (isset($_POST['search'])) {
    ...
    $query = "SELECT books.*, authors.name AS author FROM books LEFT JOIN authors ON books.author_id = authors.id WHERE books.id > 12 and books.id < 25 ";
    $search_result = filterTable($query);
}
            ...
            <div class="col-12 col-sm-12 col-md-10 col-lg-8" id="row2col2">
                <div class="md-form mt-0">
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-6 col-md-12 col-lg-6" id="row2col10">
                            Mathematics</div>
                    </div>
